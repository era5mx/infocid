...
if ($carne==''){
 ...
 $sql = "select registro, autor, codigo, titulo, prestado from libro where titulo like upper('%$nom%') order by titulo asc";
 ...
 $sql2 = "insert into estadistica (numero, item, encont, fecha, lector, criterio)
	  values ('$att', upper('$nom'), '$registro',now(), upper('$carne'),'TITULO')";
...
$mensaje='Se ha encontrado '.$registro.' libro(s) con la cadena <B>"'.$cadena.'"</B> incluida en el título';
